...
try {
  ...
  const identity = createIdentityStore({ dataRoot }); const caller = await identity.beginCallerTurn({ sessionId: input.session_id, turnId: input.turn_id, workspace: input.cwd, permissionMode: input.permission_mode });
